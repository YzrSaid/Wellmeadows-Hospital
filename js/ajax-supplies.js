$(document).ready(function () {
  ...
  function submitSupply(supplyData) {
      ...
      if ((!supplyData.item_name && !supplyData.drug_name) || !supplyData.quantity_stock || !supplyData.reorder_level || !supplyData.cost_per_unit) {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetchSupplies("pharmaceutical", pharmaTableSelector, pharmaSearchInputSelector);
    ...
    if (editButton) {
        editButton.addEventListener("click", () => {
            const descriptionTextarea = document.querySelector("#phar-supply-description");
        ...
        .then(data => {
            ...
            data.forEach(supply => {
                ...
                row.addEventListener("click", () => {
                    descriptionTextarea.value = supply.description || "No description available.";
                    methodAdminTextarea.value = supply.method_of_admin || "No method available.";
            ...
            console.log(`Setting up search for ${type} supplies with input:`, searchInputId); // Log the search input
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  fetchSupplies("surgical", surgTableSelector, surgSearchInputSelector, sortSelectId);
  ...
  if (editButton) {
      editButton.addEventListener("click", () => {
          const descriptionTextarea = document.querySelector("#surg-supply-description");
